...
#else if defined(__STM32F103RET6__)
  inline static void initSS(void)    { pinMode(uSCS, OUTPUT);}
  inline static void setSS(void)    {digitalWrite(uSCS, LOW);  }
  inline static void resetSS(void)  {digitalWrite(uSCS, HIGH);  }
#endif
