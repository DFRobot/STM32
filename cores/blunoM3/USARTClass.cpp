...
void USARTClass::begin( const uint32_t dwBaudRate )
{
  ...
  if(_dwId == id_serial1)
  {
   ...
   else if(_dwId == id_serial2)//Serial2 usart2
  { 
    RCC_APB2PeriphClockCmd(RCC_APB2Periph_GPIOA | RCC_APB2Periph_AFIO, ENABLE);
  ...
  else if(_dwId == id_serial3)//Serial1 uart4
  { 
  ...
  else if(_dwId == id_serial4)//Serial3  usart3
  { 
   
    RCC_APB2PeriphClockCmd(RCC_APB2Periph_GPIOC | RCC_APB2Periph_AFIO, ENABLE);
    RCC_APB1PeriphClockCmd(RCC_APB1Periph_UART4, ENABLE); 
    pinMode(RX4, INPUT);
    pinMode(TX4, AF_OUTPUT_PUSHPULL);
 
  } 
  
  else if(_dwId == id_serial5)//Serial4 uart5
  { 
    RCC_APB2PeriphClockCmd(RCC_APB2Periph_GPIOD | RCC_APB2Periph_GPIOC | RCC_APB2Periph_AFIO, ENABLE);
    RCC_APB1PeriphClockCmd(RCC_APB1Periph_UART5, ENABLE); 
    pinMode(RX5, INPUT);
    pinMode(TX5, AF_OUTPUT_PUSHPULL);
  } 
...
void USARTClass::end( void )
{
  ...
  else if(_dwId == id_serial4)//Serial4
  {
    RCC_APB1PeriphClockCmd(RCC_APB1Periph_UART4, DISABLE);
  }
  else if(_dwId == id_serial5)//Serial5
  {
